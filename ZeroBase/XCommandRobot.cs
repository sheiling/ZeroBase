...
namespace XCore
{
    ...
    public abstract class XCommandRobot : XTask
    {
        ...
        /// <returns></returns>
        public virtual bool JumpL(double[] tarPostion, int vel, int timeout, bool waitMotionDone = true, double limtZ = 200)
        {
            return false;
        }
        ...
        /// <param name="limtZ"></param>
        /// <returns></returns>
        public virtual bool JumpS(double[] tarPostion, int vel, int timeout, bool waitMotionDone = true, double limtZ = 200)
        {
            return false;
        }
